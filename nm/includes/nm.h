...
*** create.c
*/
t_cmd				*create_cmd(t_cmd *cmds, char *table,
						struct nlist_64 list, t_env *env);
t_cmd				*create_cmd_32(t_cmd *cmds, char *table,
						struct nlist list, t_env *env);
...
void				h32_seg(struct mach_header *h,
						struct load_command *lc, t_env *env);
void				h32_sym(struct mach_header *h,
						struct load_command *lc, t_env *env);
...
void				h64_seg(struct mach_header_64 *h,
						struct load_command *lc, t_env *env);
void				h64_sym(struct mach_header_64 *h,
						struct load_command *lc, t_env *env);
